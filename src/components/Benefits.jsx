    ...
    <Section crosses>
        <div className='container lg:flex'>
            <div className='max-w-[25rem]'>
                <h2 className='h2 mb-4 md:mb-8'>Event Schedule</h2>
            ...
            <div className='lg:ml-auto xl:w-[38rem] mt-4'>
                <p className='body-2 mb-4 text-n-4 md:mb-16 lg:mb-32 lg:w-[32rem] lg:mx-auto'>Any sufficiently advanced technology is indistinguishable from magic. <br ></br>
                    ~Arthur C. Clarke
                </p>

                <div className='relative left-1/2 flex w-[22rem] aspect-square border border-n-6 -translate-x-1/2 scale-75 md:scale-100 rounded-full'>
